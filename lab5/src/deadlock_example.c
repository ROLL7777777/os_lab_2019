...
void main() {
    ...
    init_philosopher(&philosophers[0], "Vania", 0, 1);
    init_philosopher(&philosophers[1], "Petr", 1, 2);
    init_philosopher(&philosophers[2], "Oleg", 2, 3);
    init_philosopher(&philosophers[3], "Farit", 3, 4);
    init_philosopher(&philosophers[4], "Dima", 4, 0);
